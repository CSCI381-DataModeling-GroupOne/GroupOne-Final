IF OBJECT_ID('[Utils].[uvw_FindColumnDefinitionPlusDefaultAndCheckConstraint]') IS NOT NULL
	DROP VIEW [Utils].[uvw_FindColumnDefinitionPlusDefaultAndCheckConstraint];
